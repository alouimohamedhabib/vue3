<template>
  <div class="fixed h-full w-full bg-black bg-opacity-80 top-0 left-0 flex justify-center items-center" v-if="task">
    <div class="todo bg-white p-4 rounded  w-4/12 h-40/6">
      <div class="mb-6">
        <label for="large-input" class="block mb-2 text-sm font-medium text-gray-900 ">Todo content</label>
        <input type="text" id="large-input" v-model="props.task.todo"
...
const props = defineProps({
  task: {
    type: Object as PropType<TaskObject>, default: null
  }
})
